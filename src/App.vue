...
<template>
  <div
    class="flex flex-col h-screen bg-gray-100 dark:bg-[#08060d] font-sans text-gray-900 dark:text-gray-100"
  >
    <div class="flex flex-1 overflow-hidden">
      ...
      <aside
        :class="[
          ...
          'bg-[#2b2b34] text-white transition-all duration-300 flex flex-col shadow-xl z-20',
        ]"
      >
        <div
        ...
        >
          <span v-if="menuAberto" class="font-bold text-lg tracking-wider"
            >HELPDESK <span class="text-red-500">AI</span></span
          >
          <span v-else class="font-bold text-xl text-red-500">H</span>
        </div>
        ...
        <div
          class="p-4 border-t border-white/10 flex items-center gap-3 overflow-hidden"
        >
          <div
            :class="[
              perfilAtual === 'cliente' ? 'bg-red-600' : 'bg-gray-500',
        ...
        >
          ...
          <div class="flex items-center gap-6">
            <button
              ...
              class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm flex items-center gap-2"
            >
    ...
    <div
      class="px-6 py-4 bg-[#f4f3ec] dark:bg-[#1f2028] border-t border-[#e5e4e7] dark:border-[#2e303a] flex justify-between items-center z-20 relative flex-shrink-0"
    >
